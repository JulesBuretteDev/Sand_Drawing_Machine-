...
class Arduino:
    ...
    def find_port(self):
        ports = ['COM{}'.format(i) for i in range(1, 10)]
        for port in ports:
            try:
...
myValues = Values([Value("heure",0,""),Value("jour",1,""),Value("mois",2,""),Value("annee",3,""),Value("temp",4,""),Value("netTemp",5,""),Value("humid",6,""),Value("dateJour",7,"")])
memValues = Values([Value("heure",0,""),Value("jour",1,""),Value("mois",2,""),Value("annee",3,""),Value("temp",4,""),Value("netTemp",5,""),Value("humid",6,""),Value("dateJour",7,"")])
# print(myValues)
myArduino = Arduino()
# print(myArduino)
